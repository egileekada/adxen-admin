...
import { Check, MoreHorizontal, RefreshCcw, Undo2 } from "lucide-react"; 
...
export const walletColumns: ColumnDef<TableData>[] = [
  {
  ...
  },
  {
    ...
    cell: () => {
      ...
      return (
        <div onClick={()=> openModal("withdraw-details")} className="flex items-center gap-8 w-full justify-end"> 
