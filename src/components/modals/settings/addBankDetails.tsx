...
export default function AddBankDetails() {
        ...
        return (
            <div>
                ...
                <div className=" w-full flex flex-col gap-3 px-5 pb-5 " >
                    ...
                    <CustomInput placeholder="" label="Bank Name" name={""} setValue={changeHandler} />
                    <CustomInput placeholder="" label="Bank Account number" name={""} setValue={changeHandler} />
                    <CustomInput placeholder="" label="Account type" name={""} setValue={changeHandler} />
                    <CustomInput placeholder="" label="Routing number" name={""} setValue={changeHandler} />
                    <CustomInput placeholder="" label="Account name" name={""} setValue={changeHandler} />
                </div>
    ...
    if (isMobile)
        return (
            <DrawerLayout isOpen={isOpen} closeModal={closeModal} breadcrumb={["Settings"]} header="Add Bank Details" >
                <BankForm />
            </DrawerLayout>
        );

    return (
        <SheetLayout isOpen={isOpen} closeModal={closeModal} breadcrumb={["Settings"]} header="Add Bank Details" >
            <BankForm />
        </SheetLayout>
    );
}; 