...
export default function AddWise() {
    ...
    if (isMobile)
        return (
            <DrawerLayout isOpen={isOpen} closeModal={closeModal} breadcrumb={["Settings"]} header="Add Wise account" >
                <WiseForm />
            </DrawerLayout>
        );

    return (
        <SheetLayout isOpen={isOpen} closeModal={closeModal} breadcrumb={["Settings"]} header="Add Wise account" >
            <WiseForm />
        </SheetLayout>
    );
}; 